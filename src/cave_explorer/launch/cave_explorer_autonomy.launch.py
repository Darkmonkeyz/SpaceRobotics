...
def generate_launch_description():
    ...
    cave_explorer_node = Node(
        ...
        parameters=[{'use_sim_time': LaunchConfiguration('use_sim_time'),
                    ...
                    'computer_vision_model_filename': PathJoinSubstitution(config_path+['stop_data.xml']), 'computercooler_vision_model_filename': PathJoinSubstitution(config_path+['model.pt'])}]
    )
